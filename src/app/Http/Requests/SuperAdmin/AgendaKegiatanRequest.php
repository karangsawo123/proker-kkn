...
class AgendaKegiatanRequest extends FormRequest
{
    ...
    {
        return [
            'scope_level.required' => 'Cakupan wilayah kegiatan wajib dipilih.',
            'scope_level.in' => 'Cakupan wilayah harus berupa DESA atau DUSUN.',
            'dusun_id.required' => 'Wilayah dusun wajib dipilih untuk kegiatan tingkat dusun.',
            'dusun_id.required_if' => 'Wilayah dusun wajib dipilih untuk kegiatan tingkat dusun.',
            'dusun_id.prohibited_if' => 'Wilayah dusun tidak boleh dipilih untuk kegiatan tingkat desa.',
            'dusun_id.exists' => 'Wilayah dusun yang dipilih tidak valid.',
            'judul.required' => 'Judul agenda wajib diisi.',
            'deskripsi_singkat.required' => 'Deskripsi kegiatan wajib diisi.',
