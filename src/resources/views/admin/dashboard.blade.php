...
<div class="admin-page-header">
    <div>
        ...
        <p class="admin-page-desc">Panel pengelolaan data wilayah <strong>{{ $dusun->nama_dusun }}</strong></p>
    </div>
</div>
...
<div class="admin-stats-grid">
    <div class="stat-card">
        ...
        <a href="{{ route('admin-dusun.kontak.index') }}" class="stat-card-link">
            Kelola Kontak
    ...
    <div class="stat-card">
        ...
        <div class="stat-card-label">UMKM Terdaftar</div>
        <div class="stat-card-value">{{ $umkmCount }}</div>
        <a href="{{ route('admin-dusun.umkm.index') }}" class="stat-card-link">
            Kelola UMKM
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/>
            </svg>
    ...
    <div class="stat-card">
        ...
        <div class="stat-card-label">Fasilitas Dusun</div>
        <div class="stat-card-value">{{ $fasilitasCount }}</div>
        <a href="{{ route('admin-dusun.fasilitas.index') }}" class="stat-card-link">
            Kelola Fasilitas
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/>
            </svg>
    ...
    <div class="stat-card">
        ...
        <a href="{{ route('admin-dusun.agenda.index') }}" class="stat-card-link">
            Kelola Agenda
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/>
            </svg>
    ...
    <div class="stat-card">
        ...
        <div class="stat-card-label">Pengumuman Aktif</div>
        <div class="stat-card-value">{{ $pengumumanCount }}</div>
        <a href="{{ route('admin-dusun.pengumuman.index') }}" class="stat-card-link">
            Kelola Pengumuman
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/>
            </svg>
