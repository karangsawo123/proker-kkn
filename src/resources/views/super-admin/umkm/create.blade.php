...
@section('title', 'Tambah Usaha (UMKM)')
@section('breadcrumb')
    <a href="{{ route('super-admin.dashboard') }}">Dashboard</a> /
    <a href="{{ route('super-admin.umkm.index') }}">Kelola UMKM</a> /
    <span>Tambah Baru</span>
@endsection

@section('content')
<div class="admin-page-header">
    <h1 class="admin-page-title">Tambah Usaha (UMKM)</h1>
    <p class="admin-page-desc">Daftarkan usaha warga di salah satu dusun di Desa Bendung.</p>
</div>

<div class="admin-card">
    <div class="admin-card-header">
        <h2 class="admin-card-title">Formulir Pendaftaran UMKM</h2>
    </div>
    <div class="admin-card-body">
        <form method="POST" action="{{ route('super-admin.umkm.store') }}" enctype="multipart/form-data" class="admin-form">
            @csrf
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input
                        ...
                        required
                        maxlength="150"
                        placeholder="Contoh: Ibu Sulastri"
                    >
                    @error('nama_pemilik')
                        <p class="field-error">{{ $message }}</p>
                    @enderror
            ...
            <div class="form-row">
                <div class="form-group">
                    <label for="nomor_whatsapp" class="form-label">
                        Nomor WhatsApp Pemesanan <span class="required-mark">*</span>
                    </label>
                    <input
                        type="text"
                        name="nomor_whatsapp"
            ...
            <div class="form-group">
                ...
                <textarea
                    ...
                    required
                    placeholder="Jelaskan mengenai produk, keunggulan usaha, atau bahan baku yang digunakan..."
            ...
            <div class="form-section-box">
                <div class="flex-between" style="margin-bottom: 0.75rem;">
                    <div>
                        ...
                        <p class="section-box-desc">Tambahkan daftar nama produk yang dihasilkan atau dijual.</p>
                    </div>
            ...
            <div class="form-group">
                ...
                <x-admin.coordinate-picker
                    ...
                    mapId="saUmkmCreateMap"
                />
            </div>

            <div class="form-actions">
                <a href="{{ route('super-admin.umkm.index') }}" class="btn btn-secondary">Batal</a>
