...
<div class="admin-page-header">
    ...
    <p class="admin-page-desc">Perbarui data usaha warga dan katalog produk.</p>
</div>
...
<div class="admin-card">
    ...
    <div class="admin-card-body">
        <form method="POST" action="{{ route('super-admin.umkm.update', $umkm->id) }}" enctype="multipart/form-data" class="admin-form">
            @csrf
            @method('PUT')
            ...
            <div class="form-section-box">
                <div class="flex-between" style="margin-bottom: 0.75rem;">
                    <div>
                        ...
                        <p class="section-box-desc">Kelola daftar nama produk katalog usaha.</p>
                    </div>
